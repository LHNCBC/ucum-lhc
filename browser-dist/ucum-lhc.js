      ...
      if (aftText) {
        ...
        // user that it's not valid - but try it anyway
            ...
            if (intUtils_.isNumericString(aftText)) {
              retUnit = null;
              var msg = "An exponent (".concat(aftText, ") following a parenthesis ") + "is invalid as of revision 1.9 of the UCUM Specification."; // Add the suggestion only if the string in the parenthesis don't end with a number.
